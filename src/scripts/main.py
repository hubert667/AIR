...
if dataset == 'letor':
    feature_count = 64
    path_train = 'Datasets/LETORConcat/2004Concat/Fold2/train.txt'
    path_test = 'Datasets/LETORConcat/2004Concat/Fold2/test.txt'
    path_validate = 'Datasets/LETORConcat/2004Concat/Fold2/vali.txt'
